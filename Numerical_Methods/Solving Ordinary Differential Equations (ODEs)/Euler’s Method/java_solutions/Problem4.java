public class Problem4 {
    public static void main(String[] args) {
        ...
        double targetX = 0.2; // Target x value
        
        System.out.println("Euler's Method Solution for Problem 4");
        System.out.println("y' = sin(x) + cos(y), y(0) = 0");
        ...
        while (x <= targetX) {
            ...
            double slope = Math.sin(x) + Math.cos(y);  // f(x,y) = sin(x) + cos(y)
            y = y + h * slope;
            x = x + h;
        }
    }
