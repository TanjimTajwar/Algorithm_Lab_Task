public class Problem5 {
    ...
    public static void main(String[] args) {
        ...
        double b = 5;  // Upper limit
        int n = 18;    // Number of intervals

        try {
            double result = weddlesRule(a, b, n);
            double exactValue = b * Math.log(b) - b - (a * Math.log(a) - a);  // Integral of ln(x) is x*ln(x) - x
            double error = Math.abs(result - exactValue);
            double percentageError = (error / exactValue) * 100;
            ...
            System.out.printf("Percentage error: %.6f%%%n", percentageError);
